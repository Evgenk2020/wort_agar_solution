...
void help_info::see_info()
{
    std::cout << "*** Визначення об'єму компонентів суслового агару з натуральної сировини ***" << std::endl
              ...
              << "-d <початкова_концентрація_(%)> <кінцева_концентрація_(%)> <об'єм_фільтрату_(мл)>" << std::endl
              << std::endl
              << "Для виводу у файл:" << std::endl
              << "-df <початкова_концентрація_(%)> <кінцева_концентрація_(%)> <об'єм_фільтрату_(мл)>" << std::endl
              << std::endl
