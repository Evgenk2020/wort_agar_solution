...
void help_info::see_info()
{
    std::cout << "*** Визначення об'єму компонентів суслового агару з натуральної сировини ***" << std::endl
              ...
              << "wort -d [початкова_концентрація %] [кінцева_концентрація %] [об'єм_фільтрату мл]" << std::endl
              << "Для виводу у файл" << std::endl
              << "wort -df [початкова_концентрація %] [кінцева_концентрація %] [об'єм_фільтрату мл]" << std::endl
...
void file_info::see_info(wort_solution *wrt)
{
    ...
    std::cout << "Дані додані в файл wort-dada.csv" << std::endl;
}
